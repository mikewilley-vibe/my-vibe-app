            ...
            <div className="mb-16">
              ...
              <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <Link
                  ...
                  className="group overflow-hidden rounded-xl border border-slate-200 hover:border-blue-400 transition-all"
                >
                  <div className="bg-gradient-to-br from-blue-50 to-slate-50 p-6 flex flex-col items-center justify-center hover:from-blue-100 hover:to-slate-100 transition-colors h-48">
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group overflow-hidden rounded-xl border border-slate-200 hover:border-amber-400 transition-all"
                >
                  <div className="bg-gradient-to-br from-amber-50 to-slate-50 p-6 flex flex-col items-center justify-center hover:from-amber-100 hover:to-slate-100 transition-colors h-48">
                    <div className="text-4xl mb-3">📖</div>
                ...
                <Link
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="group overflow-hidden rounded-xl border border-slate-200 hover:border-emerald-400 transition-all"
                >
                  <div className="bg-gradient-to-br from-emerald-50 to-slate-50 p-6 flex flex-col items-center justify-center hover:from-emerald-100 hover:to-slate-100 transition-colors h-48">
